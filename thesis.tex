...
\captionsetup[figure]{labelsep=quad}      % 図のキャプションの形式を "図6.1(スペース)" に設定
\captionsetup[table]{labelsep=quad}  % 表のキャプションの形式を "表6.1(スペース)" に設定
...
\begin{thebibliography}{99}
  ...
  \bibitem{Syuuronn-shigematu}重松颯人，``補聴器を想定した音声における入出力の遅延時間の許容範囲についての検討''，明治大学大学院理工学研究科電気工学専攻知能信号処理研究室，2019年度修士学位請求論文.
