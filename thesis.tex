...
% >> platex thesis.tex もしくは uplatex thesis.tex
% >> dvipdfmx thesis.dvi
%
...
\captionsetup[figure]{labelsep=quad}      % 図のキャプションの形式を "図6.1(大きめのスペース)" に設定
\captionsetup[table]{labelsep=quad}  % 表のキャプションの形式を "表6.1(大きめのスペース)" に設定
...
\lstset{
  ...
  commentstyle={\ttfamily}, % コメントのスタイル
  ...
  numbers=none,             % 行番号の有無
  xrightmargin=0zw,         % 右の余白
  xleftmargin=0zw,          % 左の余白
  keepspaces=true,          % スペースの有無
  columns=[l]{fullflexible},% 文字の間隔の調整
  lineskip=-0.5ex           % 行間の調整
}
\renewcommand{\lstlistingname}{ソースコード} % キャプション名を変更
%%%%% ここまでソースコードの表示に関する設定 %%%%%
...
\begin{thebibliography}{99}
  ...
  \bibitem{DelayTime-ninnchi}硲田猛真，中村陽裕，福本儀智，長谷川賢作，北野博也，``ディレイタイムの認知閾値''，Audiology Japan, 46巻, 5号, pp.465-467, Sep. 2007.
  ...
  \bibitem{shigematu-toukyoushibu}重松颯人，村上隆啓，``高齢者の聴覚における遅延時間の許容量の評価''，平成29年度電子情報通信学会東京支部学生会研究発表会講演論文集，pp.143, Mar. 2018.
  \bibitem{Syuuronn-shigematu}重松颯人，``補聴器を想定した音声における入出力の遅延時間の許容範囲についての検討''，明治大学大学院理工学研究科，2019年度修士学位請求論文，Feb. 2020.
  ...
  \bibitem{Soturonn-takahashi}高橋浩貴，村上隆啓，``補聴器における遅延時間の許容量の評価''，平成26年度電子情報通信学会東京支部学生会研究発表会講演論文集, p168, Sep. 2015.

\end{thebibliography}
\begin{thepublished}{99}
	\bibitem{cf:yamashita}山下一樹，安田和生，丹治寛樹，村上隆啓，``若年者と高齢者の遅延聴覚フィードバックの身体運動への影響の比較''，2023年度電子情報通信学会東京支部学生会研究発表会, Mar. 2024.
...
\appendix
\input{furoku-Tex/furoku-A.tex}
\input{furoku-Tex/furoku-B.tex}
\input{furoku-Tex/furoku-C.tex}
\input{furoku-Tex/furoku-D.tex}
