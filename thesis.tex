...
\begin{thebibliography}{99}
  ...
  \bibitem{EaringAids-2}神田幸彦，``補聴器の進歩と聴覚医学'' Audiology Japan, 60巻, 2号, pp. 121-128, Apr.2017.
  ...
  \bibitem{Win32API-reference}Microsoft，``Win32 API のプログラミング リファレンス'' \url{https://docs.microsoft.com/ja-jp/windows/win32/api/}，参照2023年1月24日
  ...
  \bibitem{Soturonn-satou}佐藤和志，``ASIOを利用した音響測定装置の開発及び遅延時間の許容量の調査''，明治大学理工学部電気電子生命学科知能信号処理研究室，2015年度卒業論文
